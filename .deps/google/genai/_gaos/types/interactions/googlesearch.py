...
class GoogleSearch(BaseModel):
    ...
    type: Annotated[
        Annotated[
            Literal["google_search"], AfterValidator(validate_const("google_search"))
        ],
    ...
    def serialize_model(self, handler):
        optional_fields = set(["search_types"])
